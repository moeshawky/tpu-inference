...
class VllmQKVParallelLinear(QKVParallelLinear):
    ...
    def forward(
        ...
        # NOTE (2026-09-10, flash bring-up): skip the KV-replica sharding
        # annotation. It builds a 3-axis (data, model, replica) mesh nested
        ...
        # The annotated op is value-identity (`return t`), so skipping it
